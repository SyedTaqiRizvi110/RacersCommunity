...
namespace RacersCommunity.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CityName,StateCode,Zip,Country")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CityName,StateCode,Zip,Country")] City city)
        {
            if (id != city.Id)
            {
                return NotFound();
